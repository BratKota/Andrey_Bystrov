...
def process_csv_files():
    try:
        ...
        output_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'X_Y')
        ...
        for input_csv_file in input_csv_files:
            ...
            output_x_csv_file = os.path.join(output_folder, f'X.csv')
            output_y_csv_file = os.path.join(output_folder, f'Y.csv')
